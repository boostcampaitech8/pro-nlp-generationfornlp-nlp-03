...
from prompt_utils import (
        ...
        SYSTEM_MESSAGE,
        PROMPT_NO_QUESTION_PLUS_CHOICE_NUM,
        PROMPT_QUESTION_PLUS_CHOICE_NUM,
        SYSTEM_MESSAGE_CHOICE_NUM,
    )
...
PROMPT_NO_QUESTION_PLUS = PROMPT_NO_QUESTION_PLUS_CHOICE_NUM

PROMPT_QUESTION_PLUS = PROMPT_QUESTION_PLUS_CHOICE_NUM

SYSTEM_MESSAGE = SYSTEM_MESSAGE_CHOICE_NUM
...
def tokenize_dataset(
    ...
    def tokenize(element):
        outputs = tokenizer(
            ...
            # truncation=False,
            truncation=True,              # ✅ 여기
            max_length=max_seq_length,    # ✅ 여기 추가
            padding=False,
