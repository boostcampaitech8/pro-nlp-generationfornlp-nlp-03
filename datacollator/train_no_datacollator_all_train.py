...
def train(config):
    ...
    train_result = trainer.train(resume_from_checkpoint="/data/ephemeral/home/nykwak/qwen/results/Qwen2.5-32B-Instruct-bnb-4bit-CPT-epoch3_no_datacollator_all_train/checkpoint-384")
